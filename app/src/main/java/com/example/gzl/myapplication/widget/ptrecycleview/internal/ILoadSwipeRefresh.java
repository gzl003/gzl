package com.example.gzl.myapplication.widget.ptrecycleview.internal;


import com.example.gzl.myapplication.widget.ptrecycleview.SwipeRefreshAdapterView;
...
public interface ILoadSwipeRefresh {
     ...
     * @param isVisbe
     */
    void setLoadViewVisibe(boolean isVisbe);
