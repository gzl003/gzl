...
public class BannerView extends Holder<Museum.ResultBean.HeadBean> {
    ...
    public BannerView(View itemView, Context mContext) {
        super(itemView);
...
//    }
    ...
    @Override
    public void updateUI(Museum.ResultBean.HeadBean data) {
        textTitle.setText(data.title);
        textDes.setText(data.appslogan);
        /**
         常用的图片加载库：
