...
public class GzlBanner<T> extends RelativeLayout {
    ...
    private GzlPagerAdapter<T> pageAdapter;
    ...
    public GzlBanner(Context context) {
        super(context);
        init(context);
    }

    public GzlBanner(Context context, AttributeSet attrs) {
        super(context, attrs);
    ...
    public GzlBanner setLayoutManager(RecyclerView.LayoutManager layoutManager) {
     ...
     * @param visible
     */
    public GzlBanner setPointViewVisible(boolean visible) {
     ...
     */
    public GzlBanner setPageIndicator(int[] page_indicatorId) {
     ...
     */
    public GzlBanner setOnItemClickListener(final OnItemClickListener onItemClickListener) {
     ...
     * @return
     */
    public GzlBanner setPageIndicatorAlign(GzlBanner.PageIndicatorAlign align) {
        RelativeLayout.LayoutParams layoutParams = (RelativeLayout.LayoutParams) loPageTurningPoint.getLayoutParams();
        layoutParams.addRule(RelativeLayout.ALIGN_PARENT_LEFT, align == GzlBanner.PageIndicatorAlign.ALIGN_PARENT_LEFT ? RelativeLayout.TRUE : 0);
        layoutParams.addRule(RelativeLayout.ALIGN_PARENT_RIGHT, align == GzlBanner.PageIndicatorAlign.ALIGN_PARENT_RIGHT ? RelativeLayout.TRUE : 0);
        layoutParams.addRule(RelativeLayout.CENTER_HORIZONTAL, align == GzlBanner.PageIndicatorAlign.CENTER_HORIZONTAL ? RelativeLayout.TRUE : 0);
    ...
    public void setPagePadding(int pagePadding) {
        pageAdapter.setPagePadding(pagePadding);
    }

    public void setShowLeftCardWidth(int showLeftCardWidth) {
        pageAdapter.setShowLeftCardWidth(showLeftCardWidth);
    }
    ...
    static class AdSwitchTask implements Runnable {
        ...
        private final WeakReference<GzlBanner> reference;

        AdSwitchTask(GzlBanner convenientBanner) {
            this.reference = new WeakReference<GzlBanner>(convenientBanner);
        }

        @Override
        public void run() {
            GzlBanner convenientBanner = reference.get();
