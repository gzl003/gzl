...
/**
 * @author: 智光
 * @time: 2023/5/26 16:39
 * @desc: 功能描述
 */
public class BubblePopupWindow  extends PopupWindow {

    private HornLayout bubbleView;
    ...
    public void setBubbleView(View view) {
        bubbleView = new HornLayout(context);
    ...
    public void show(View parent, int gravity, float bubbleOffset) {
        HornLayout.HornOrientation orientation = HornLayout.HornOrientation.LEFT;
        if (!this.isShowing()) {
            switch (gravity) {
                case Gravity.BOTTOM:
                    orientation = HornLayout.HornOrientation.TOP;
                    break;
                case Gravity.TOP:
                    orientation = HornLayout.HornOrientation.BOTTOM;
                    break;
                case Gravity.RIGHT:
                    orientation = HornLayout.HornOrientation.LEFT;
                    break;
                case Gravity.LEFT:
                    orientation = HornLayout.HornOrientation.RIGHT;
                    break;
                default:
                    break;
            }
